        ...
        <div className="mx-auto grid max-w-6xl gap-16 md:grid-cols-[1fr_300px] md:items-center lg:grid-cols-[1fr_350px]">
          <div>
            ...
            <ScrollReveal delay={0.2}>
              <p className="mt-8 max-w-lg text-lg leading-relaxed text-[#a3a3a3]">
                {bio.about[0]}
              </p>
            </ScrollReveal>

            <ScrollReveal delay={0.3}>
              <p className="mt-4 max-w-lg text-base leading-relaxed text-[#737373]">
                {bio.about[2]}
              </p>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.5}>
              <div className="mt-12 flex gap-12">
                {bio.stats.map((stat) => (
                  <div key={stat.label}>
                    <div className="font-mono text-4xl font-bold text-[#f5f5f5] md:text-5xl">
                      {stat.value}{stat.suffix}
                    </div>
                    <div className="mt-1 text-xs uppercase tracking-wider text-[#737373]">
                      {stat.label}
                    </div>
                  </div>
                ))}
          ...
          <ScrollReveal delay={0.3}>
            <div className="relative mx-auto w-64 md:w-full">
              ...
              <div className="absolute -bottom-4 -right-4 h-full w-full rounded-2xl border border-white/5 -z-10" />
              <div className="absolute -top-4 -left-4 h-full w-full rounded-2xl border border-white/5 -z-10" />
            </div>
          </ScrollReveal>
        </div>
      </div>
